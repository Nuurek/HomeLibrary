...
from libraries.views import LibraryBookCopyCreateView, LibraryBookCopiesListView
from .views import *

urlpatterns = [
    url(r'^copy/create$', LibraryBookCopyCreateView.as_view(), name='book_copy_create'),
